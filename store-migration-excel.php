...
defined( 'WPFACTORY_WC_PROCM_VERSION' ) || define( 'WPFACTORY_WC_PROCM_VERSION', '3.0.2' );
 ...
 * @version 3.0.0
 *
 * @todo    (v3.0.0) remove all `extend-wp` mentions
 * @todo    (v3.0.0) rename plugin to "... for WooCommerce"
 */
